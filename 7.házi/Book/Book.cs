...
namespace myproducts
{
    public class Book : Product
    {
        ...
        public Book(string author, string title, int price, int pages, string style) : base("book", price)
        {
            this.author = author;
            this.title = title;
            this.style = style;
        ...
        public Book(string author, string title, string style) : base("book", 2500)
        {
            this.author = author;
            this.title = title;
            this.pages = 100;
        ...
        public override string ToString()
        {
            return " " + this.author + ": " + this.title + ", " +
                this.yearOfPublication + " pp " + this.pages + " ar: " + this.price + " " + this.style;
        }
